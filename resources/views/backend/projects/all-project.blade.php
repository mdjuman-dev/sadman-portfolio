                ...
                <tbody>
                    @forelse ($Projects as $key => $items)
                        <tr>
                            ...
                            <td>
                                <a wire:navigate href="{{ route('project.view', $items->slug) }}"
                                    class="btn btn-sm btn-outline-info" title="View">
                                    <i class="mdi mdi-eye"></i>
                                </a>
                                <a wire:navigate href="{{ route('project.index', $items->id) }}"
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-muted py-4 text-center">No Blog Posts Found!</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
