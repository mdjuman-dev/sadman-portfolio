                                    ...
                                    <li>
                                        <div class="tag-wrap">
                                            ...
                                            <span class="tag-title">
                                                <a wire:navigate
                                                    href="{{ route('category.blog', $blogDetails->category->slug) }}">{{ $blogDetails->category->name }}
                                                </a>
                                            </span>
                                        </div>
                                    </li>
                                ...
                                @foreach ($blogs as $items)
                                    <div class="single-post-card tmp-hover-link">
                                        ...
                                        <div class="single-post-right">
                                            ...
                                            <h3 class="post-title"><a wire:navigate class="link"
                                                    href="{{ route('blog.details', $items->slug) }}">{{ Str::limit($items->title, 50) }}</a>
                                            </h3>
                                        </div>
                                    </div>
                                @endforeach
