            ...
            <div class="col-12 col-lg-6 col-xl-6 col-xxl-6">
                <div
                    ...
                    <div class="year-expariance-wrap">
                        ...
                        <h2 class="counter year-number"><span class="odometer" data-count="{{$counter->years}}">00</span>+
                        </h2>
                        <h3 class="year-title">Years Of <br> experience</h3>
                    </div>
                    <p class="year-para">{{$counter->dec}}</p>
                </div>
            </div>
            <div class="col-12 col-lg-6 col-xl-6 col-xxl-6">
                    ...
                    <div class="row g-5">
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="counter-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-1">
                                <h3 class="counter counter-title">
                                    <span class="odometer" data-count="{{$counter->project_complete}}">00</span>+
                                </h3>
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="counter-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-2">
                                <h3 class="counter counter-title"><span class="odometer" data-count="{{ $counter->natural_product }}">00</span>+
                                </h3>
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="counter-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-3">
                                <h3 class="counter counter-title"><span class="odometer" data-count="{{ $counter->clients_reviews }}">00</span>+
                                </h3>
                        ...
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="counter-card tmponhover tmp-scroll-trigger tmp-fade-in animation-order-4">
                                <h3 class="counter counter-title"><span class="odometer" data-count="{{ $counter->satisfied_clientd }}">00</span>+
                                </h3>
